...
- [Services](services.md) -- `submit_alert`, `resolve_alert`, and `trigger_alert` service definitions
- [Architecture](architecture.md) -- System architecture overview
- [Archive: Alert Integration Analysis](../archive/alert-integration-analysis.md) -- Historical analysis document
- [Archive: Alert Integration Complete](../archive/alert-integration-complete.md) -- Historical implementation notes
